...
public:
 PosixThread(PlatformThread * _parent_thread, std::shared_ptr<FWApplication> & _application, std::shared_ptr<Runnable> & _runnable)
   : PlatformThread(_parent_thread, _application, _runnable),
