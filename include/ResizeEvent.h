...
public:
 ResizeEvent(int _logical_width, int _logical_height, int _actual_width, int _actual_height )
   : logical_width(_logical_width), logical_height(_logical_height), actual_width(_actual_width), actual_height(_actual_height) { }
