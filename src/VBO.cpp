...
VBO::bind() {
  ...
  if (vbo) {
    ...
    switch (getDataType()) {
    case C4F_N3F_V3F:
      glVertexAttribPointer(0, 4, GL_FLOAT, GL_FALSE, getStride(), (void *)(0 * sizeof(float)));
      glVertexAttribPointer(1, 3, GL_FLOAT, GL_FALSE, getStride(), (void *)(7 * sizeof(float)));
      break;
    case T2F_N3F_V3F:
      ...
      break;
    case T2F_C4F_N3F_V3F:
      glVertexAttribPointer(0, 2, GL_FLOAT, GL_FALSE, getStride(), (void *)(0 * sizeof(float)));
      glVertexAttribPointer(1, 4, GL_FLOAT, GL_FALSE, getStride(), (void *)(2 * sizeof(float)));
      glVertexAttribPointer(2, 3, GL_FLOAT, GL_FALSE, getStride(), (void *)(9 * sizeof(float)));
      break;
    case NODES:
      glVertexAttribPointer(0, 4, GL_UNSIGNED_BYTE, GL_TRUE, getStride(), (void *)(0)); // color
      // skip normal
      glVertexAttribPointer(1, 3, GL_FLOAT, GL_FALSE, getStride(), (void *)(8)); // position
      glVertexAttribPointer(2, 1, GL_FLOAT, GL_FALSE, getStride(), (void *)(20)); // age
      glVertexAttribPointer(3, 1, GL_FLOAT, GL_FALSE, getStride(), (void *)(24)); // size
      glVertexAttribPointer(4, 2, GL_UNSIGNED_SHORT, GL_FALSE, getStride(), (void *)(28));
      break;
    case BILLBOARDS:
...
VBO::upload(DataType type, const void * ptr, size_t size) {
  ...
  case VBO::NODES: stride = 8 * sizeof(float); break;
